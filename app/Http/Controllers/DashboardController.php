...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($user->roles->type == "Admin") {
            ...
            $totalRevenueLast = Order::where('payment_status_id', 2)->where('created_at', '>=', now()->subWeek())->sum('final_amount');
            ...
            $totalRevenue = Order::where('order_by_id', $user->id)->where('payment_status_id', 2)->sum('final_amount');
            $totalRevenueLast = Order::where('order_by_id', $user->id)->where('payment_status_id', 2)->where('created_at', '>=', now()->subWeek())->sum('final_amount');
