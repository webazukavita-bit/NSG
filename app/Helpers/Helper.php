...
class Helper
{
    ...
    {
        // 1. Basic Validation
        if (empty($data['phone_number']) || empty($data['template_name'])) {
            return;
        }
        ...
        try {
            ...
            $payload = [
                ...
                'template_name'        => $templateConfig->flexgo_template_name,
            ...
            ])->post('https://www.flexgoapi.com/api/c2f2d736-84d7-474c-afdf-396663a294/contact/send-template-message?token=1mA3Lg5T4gODw13anSO7cX2XZfw9tyRGc10GMbaL1tf2n5gmQ0n', $payload);
