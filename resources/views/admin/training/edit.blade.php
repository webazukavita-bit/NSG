        ...
        <div class="card-body">
            ...
            <div class="card-title d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-primary">Update Session</h5>
                </div>
                <div>
                    <a href="{{ route('trainings') }}" class="btn btn-primary"><i class="bx bx-list-ol"></i> Session List</a> 
                </div>
            </div>
            <hr>
            
            <form action="{{ route('training-update',['id' => $data->id]) }}" method="POST" class="row g-3" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-3">
                    ...
                    <input type="url" name="video" class="form-control @error('video') is-invalid @enderror" id="video">
                    @error('video')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
