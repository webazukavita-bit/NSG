							...
							<div class="card-body">
								...
								<div class="clearfix">
									<p class="mb-0 float-start">
													<a class="btn btn-success d-flex align-items-center" href="{{ route('training-view', ['id' => $value->id]) }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="View"><i class="bx bx-show"></i><span>View</span></a>
												</p>
