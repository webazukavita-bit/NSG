        ...
        <div class="card-body">
            ...
            <form action="{{ route('lead-add') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select" id="source" name="source">
                            <option value="Website" @selected('Website' == old('source'))>Website</option>
                            <option value="Referral" @selected('Referral' == old('source'))>Referral</option>
                            <option value="Social Media" @selected('Social Media' == old('source'))>Social Media</option>
                            <option value="Other" @selected('Other' == old('source'))>Other</option>
                        </select>
                    </div>
                    </div>
                    <div class="row mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="source_description" name="source_description" rows="2" placeholder="Any extra details about where this lead came from">{{ old('source_description') }}</textarea>
                </div>
