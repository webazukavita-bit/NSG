    ...
    <div class="card border-top border-0 border-4 border-primary">
        <div class="card-body">
            ...
            <div class="card-title d-flex align-items-center justify-content-between">
                ...
                <div>
                    <a href="{{ route('product-categories') }}" class="btn btn-primary"><i class="bx bx-list-ol"></i> Category List</a> 
                </div>
            </div>
            <hr>
            ...
            <form action="{{ route('product-category-add') }}" method="POST" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="file_size" class="form-control @error('file_size') is-invalid @enderror" id="file_size" placeholder="Enter File Size" value="{{ old('file_size') }}" required>
                    @error('file_size')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
