                ...
                <div class="col-md-6">
                    <div class="card border-warning" id="userInfoCard" style="display:none;">
                        ...
                        <div class="card-body text-center">
                            ...
                            <h5 id="show_name" class="card-title">...</h5>
                            <p id="show_code" class="text-muted mb-1">...</p>
                            <p id="show_email" class="text-muted mb-1">...</p>
                            <p id="show_phone" class="text-muted mb-1">...</p>
                            <p id="main_balance" class="text-muted mb-1">...</p>
