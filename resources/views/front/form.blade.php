...
<div class="solar-calculator">
						...
						<div class="row">
							<div class="col-lg-7">
								...
								<!-- Slider Section Start -->
                                            <div id="solarSlider" class="carousel slide mt-2"   data-bs-ride="carousel" data-bs-interval="1000">
                                               <div class="carousel-inner ">
                                                    <div class="carousel-item active">
                                                        <img src="{{asset('images/banner/Banner_1.png')}}"
                                                            class="d-block w-100 car-img" alt="Solar Panel 1" >
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img src="{{asset('images/banner/banner_2.jpg')}}"
                                                        class="d-block w-100 car-img" alt="Solar Panel 2">
                                                    </div>
                                                    <div class="carousel-item">
                                                       <img src="{{asset('images/banner/Banner_1.png')}}"
                                                       class="d-block w-100 car-img" alt="Solar Panel 3">
                                                    </div>
                                                 </div>
                                            </div> 
                                     <!-- Slider Section end -->
        ...
        <div id="residential" class="tab-content active">
            <form id="residentialForm" action="{{route('data-store')}}" method="Post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                            ...
                            <div class="form-check my-check mt-3">
                                    <input class="form-check-input check-bg" type="checkbox" id="agree1" checked disabled>
        ...
        <div id="commercial" class="tab-content">
            <form id="commercialForm" action="{{route('data-store')}}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <div id="industrial" class="tab-content">
            ...
            <form id="industrialForm" action="{{route('data-store')}}" method="POST" enctype="multipart/form-data">
                @csrf
