...
@section('content')
    ...
    border-bottom-right-radius: 50px;">
                                    ...
                                    <div class="t-shirt-shape">
                                        <img src="{{asset('front/assets/img/hero/ts-1.png')}}" alt="img">
                                    </div>
                                    <div class="cap-shape">
                                        <img src="{{asset('front/assets/img/hero/cap-shape.png')}}" alt="img">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row g-4">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="shop-banner-items wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.1s">
                            ...
                            <div class="col-xl-7 col-lg-5 col-md-7">
                                <div class="product-right-wrapper">
                                    <div class="product-right-img">
                                        <img src="{{asset('front/assets/img/product/product-1.png')}}" alt="img">
                                        <div class="product-right-img-shape">
                                            <img src="{{asset('front/assets/img/product/product-box-shape1.png')}}" alt="img">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="shop-banner-items bg-2 wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.3s">
                        <div class="row g-4 align-items-center">
    ...
    <section class="catagories-section section-padding pt-0 section-bg fix">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="catagories-card-items">
                        <div class="thumb">
                            <img src="{{asset('front/assets/img/catagories/01.png')}}" alt="img">
                        </div>
                        <div class="content">
                            <span>50+ Style</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="catagories-card-items">
                        <div class="thumb">
                            <img src="{{asset('front/assets/img/catagories/02.png')}}" alt="img">
                        </div>
                        <div class="content">
                            <span>50+ Style</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="catagories-card-items">
                        <div class="thumb">
                            <img src="{{asset('front/assets/img/catagories/03.png')}}" alt="img">
                        </div>
                        <div class="content">
                            <span>50+ Style</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="catagories-card-items">
                        <div class="thumb">
                            <img src="{{asset('front/assets/img/catagories/04.png')}}" alt="img">
                        </div>
                        <div class="content">
                            <span>50+ Style</span>
                    ...
                    <div class="swiper-wrapper">
                        @foreach ($categories as $cat )
                            ...
                            <div class="service-image">
                                ...
                                <a href="{{url('our-services')}}" class="icon">
                        ...
                        {{-- <div class="swiper-slide">
                            <div class="service-image">
                                ...
                                <div class="service-content">
                                    <h3><a href="{{url('our-services')}}">Digital Scanning</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="service-image">
                                ...
                                <div class="service-content">
                                    <h3><a href="{{url('our-services')}}">Stickers And Labels</a></h3>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="service-image">
                                ...
                                <div class="service-content">
                                    <h3><a href="{{url('our-services')}}">Printing Service</a></h3>
                                </div>
                            </div>
                        </div> --}}
                    </div>
    ...
    <section class="feature-product-section fix section-padding pt-0">
        <div class="container">
            <div class="section-title text-center">
                <div class="sub-title wow fadeInUp">
                    <span>Our Featured Product</span>
                </div>
                <h2 class="split-text right">
            ...
            <div class="row">
                    ...
                    <div class="feature-product-items">
                        <div class="product-thumb">
                            ...
                            <ul class="product-icon d-flex justify-content-center align-items-center">
                                <li>
                                    <a href="{{url('/shop')}}"><i class="fal fa-heart"></i></a>
                                </li>
                                <li>
                        ...
                        <div class="product-content">
                            <h4><a href="{{url('/shop')}}">Bottle Lable Design</a></h4>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="feature-product-items">
                        ...
                        <div class="product-content">
                            <h4><a href="{{url('/shop')}}">Snack Packaging</a></h4>
                            
                        </div>
                        <div class="post-cat">sale!</div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="feature-product-items">
                        ...
                        <div class="product-content">
                            <h4><a href="{{url('/shop')}}">Water Bottle Print</a></h4>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                    <div class="feature-product-items">
                        ...
                        <div class="product-content">
                            <h4><a href="{{url('/shop')}}">Beanie with Logo</a></h4>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                    <div class="feature-product-items">
                        ...
                        <div class="product-content">
                            <h4><a href="{{url('/shop')}}">Winter Hoodie Print</a></h4>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".4s">
                    <div class="feature-product-items">
                        ...
                        <div class="product-content">
                            <h4><a href="{{url('/shop')}}">Girl Awesome Dress</a></h4>
                           
                        </div>
                        <div class="post-cat">sale!</div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay=".6s">
                    <div class="feature-product-banner-items">
                        ...
                        <div class="swiper feature-product-banner-slider">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="feature-product-banner-image">
                                        ...
                                        <div class="content">
                                            <h3><a href="{{url('our-services')}}">Multicoloure Printing</a></h3>
    ...
    <section class="project-section fix section-padding pt-0">
        ...
        <div class="swiper project-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="project-image-items reveal fix">
                        <img src="{{asset('front/assets/img/project/01.jpg')}}" alt="img">
                ...
                <div class="swiper-slide">
                    <div class="project-image-items reveal fix">
                        <img src="{{asset('front/assets/img/project/02.jpg')}}" alt="img">
                        <div class="project-content">
                            <div class="content">
                                <h6>Digital Products</h6>
                                <h3><a href="Javascript:void(0)">Custom Print Designing</a></h3>
                ...
                <div class="swiper-slide">
                    <div class="project-image-items reveal fix">
                        <img src="{{asset('front/assets/img/project/03.jpg')}}" alt="img">
                        <div class="project-content">
                            <div class="content">
                                <h6>Digital Products</h6>
                                <h3><a href="Javascript:void(0)">Custom Print Designing</a></h3>
    ...
    <section class="printing-feature-section fix section-padding bg-cover" style="background-image: url('{{asset('front/assets/img/feature-printing-bg.jpg')}}');">
        <div class="container">
            <div class="printing-feature-wrapper">
                <div class="row g-4 justify-content-between">
                    <div class="col-lg-6">
                        <div class="printing-feature-content">
                            <div class="section-title">
                                <div class="sub-title wow fadeInUp">
                                    <span>Let’s get printing</span>
                                </div>
                                <h2 class="split-text right">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="printing-image reveal fix">
                            <img src="{{asset('front/assets/img/feature-printing.png')}}" alt="img">
                        </div>
                    </div>
                </div>
    ...
    <section class="product-section fix section-padding">
        <div class="container">
            <div class="section-title-area">
                <div class="section-title">
                    <div class="sub-title wow fadeInUp">
                        <span>Fatured products</span>
                    </div>
                    <h2 class="split-text right">
                        Amazing Products Ready <br>
                        For Your Needs
                    </h2>
                </div>
    ...
    <section class="feation-section fix section-padding pt-0">
        <div class="container">
            <div class="feature-wrapper">
                <div class="feature-items wow fadeInUp" data-wow-delay=".2s">
                    <div class="icon">
                        <img src="{{asset('front/assets/img/icon/icon-1.svg')}}" alt="img">
                    </div>
                    <div class="content">
                        <h6>Free Shipping</h6>
                ...
                <div class="feature-items wow fadeInUp" data-wow-delay=".4s">
                    <div class="icon">
                        <img src="{{asset('front/assets/img/icon/icon-2.svg')}}" alt="img">
                    </div>
                    <div class="content">
                ...
                <div class="feature-items wow fadeInUp" data-wow-delay=".6s">
                    <div class="icon">
                        <img src="{{asset('front/assets/img/icon/icon-3.svg')}}" alt="img">
                    </div>
                    <div class="content">
                ...
                <div class="feature-items wow fadeInUp" data-wow-delay=".8s">
                    <div class="icon">
                        <img src="{{asset('front/assets/img/icon/icon-4.svg')}}" alt="img">
                    </div>
                    <div class="content">
    ...
    <!-- Shop Banner Section Start -->
    <section class="shop-banner-section-2 fix section-padding pt-0">
        <div class="container">
            <div class="row g-4">
                <div class="col-xl-6 col-lg-6 wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.1s">
                    <div class="shop-banner-items style-2 bg-cover" style="background-image: url('{{asset('front/assets/img/shop-banner/01.jpg')}}');">
                        <div class="shop-banner-content">
                ...
                <div class="col-xl-6 col-lg-6 wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.2s">
                    <div class="shop-banner-items style-2 bg-cover" style="background-image: url('{{asset('front/assets/img/shop-banner/02.jpg')}}');">
                        <div class="shop-banner-content">
                            <span>flat 25% off</span>
    ...
    <div class="marquee-section mb-5 mt-20">
        <div class="mycustom-marque">
            <div class="scrolling-wrap">
                <div class="comm">
                    <div class="icon-mar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                            <g clip-path="url(#clip0_17_180)">
                              <mask id="mask0_17_180" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="52" height="52">
                                <path d="M52 0H0V52H52V0Z" fill="white"/>
                              </mask>
                              <g mask="url(#mask0_17_180)">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M26 8.74767C24.1212 8.74767 22.5981 10.2707 22.5981 12.1495H13.8505C13.8505 5.43954 19.29 0 26 0C32.7101 0 38.1495 5.43954 38.1495 12.1495C38.1495 18.8595 32.7101 24.2991 26 24.2991V15.5514C27.8788 15.5514 29.4018 14.0283 29.4018 12.1495C29.4018 10.2707 27.8788 8.74767 26 8.74767ZM43.2523 26C43.2523 24.1212 41.7292 22.5981 39.8505 22.5981V13.8505C46.5605 13.8505 52 19.29 52 26C52 32.7101 46.5605 38.1495 39.8505 38.1495C33.1404 38.1495 27.7009 32.7101 27.7009 26H36.4486C36.4486 27.8788 37.9717 29.4018 39.8505 29.4018C41.7292 29.4018 43.2523 27.8788 43.2523 26ZM12.1495 29.4018C10.2707 29.4018 8.74767 27.8788 8.74767 26C8.74767 24.1212 10.2707 22.5981 12.1495 22.5981C14.0283 22.5981 15.5514 24.1212 15.5514 26H24.2991C24.2991 19.29 18.8595 13.8505 12.1495 13.8505C5.43954 13.8505 0 19.29 0 26C0 32.7101 5.43954 38.1495 12.1495 38.1495V29.4018ZM26 43.2523C27.8788 43.2523 29.4018 41.7292 29.4018 39.8505H38.1495C38.1495 46.5605 32.7101 52 26 52C19.29 52 13.8505 46.5605 13.8505 39.8505C13.8505 33.1404 19.29 27.7009 26 27.7009V36.4486C24.1212 36.4486 22.5981 37.9717 22.5981 39.8505C22.5981 41.7292 24.1212 43.2523 26 43.2523Z" fill="url(#paint0_linear_17_180)"/>
                              </g>
                            </g>
                            <defs>
                              <linearGradient id="paint0_linear_17_180" x1="26" y1="0" x2="26" y2="52" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#B8DBFC"/>
                                <stop offset="1" stop-color="#DDC7FB"/>
                              </linearGradient>
                    ...
                    <div class="cmn-textslide">Business Card Printing</div>
                    <div class="icon-mar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                            <g clip-path="url(#clip0_17_188)">
                              <mask id="mask0_17_188" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="52" height="52">
                                <path d="M52 0H0V52H52V0Z" fill="white"/>
                              </mask>
                              <g mask="url(#mask0_17_188)">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M26 13C26 5.82031 20.1797 1.45033e-06 13 0C13 7.17865 18.8186 12.9983 25.9969 13C18.8186 13.0017 13 18.8213 13 26C13 18.8203 7.17969 13 0 13C5.68248e-07 20.1797 5.82031 26 13 26C5.82031 26 1.70474e-06 31.8204 5.68248e-07 39C7.1785 39 12.998 33.1817 13 26.0036C13.0019 33.1817 18.8215 39 26 39C18.8203 39 13 44.8204 13 52C20.1797 52 26 46.1796 26 39C33.1796 39 39 33.1796 39 26C39 33.1796 44.8204 39 52 39C52 31.8204 46.1796 26 39 26C39 18.8203 33.1796 13 26 13ZM39 5.68248e-07C31.8204 5.68248e-07 26 5.82031 26 13C33.1796 13 39 7.17969 39 5.68248e-07ZM39 52C31.8204 52 26 46.1796 26 39C33.1796 39 39 44.8204 39 52ZM52 13C52 20.1797 46.1796 26 39 26C39 18.8203 44.8204 13 52 13Z" fill="url(#paint0_linear_17_188)"/>
                              </g>
                            </g>
                            <defs>
                              <linearGradient id="paint0_linear_17_188" x1="26" y1="0" x2="26" y2="52" gradientUnits="userSpaceOnUse">
                    ...
                    <div class="cmn-textslide">Logo Printing</div>
                    <div class="icon-mar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                            <path d="M26.0274 0L29.8998 14.0814L41.3096 4.96556L36.1658 18.6339L50.7547 17.9656L38.5594 26L50.7547 34.0345L36.1658 33.3661L41.3096 47.0345L29.8998 37.9187L26.0274 52L22.1547 37.9187L10.7449 47.0345L15.8887 33.3661L1.2998 34.0345L13.4953 26L1.2998 17.9656L15.8887 18.6339L10.7449 4.96556L22.1547 14.0814L26.0274 0Z" fill="url(#paint0_linear_17_195)"/>
                            <defs>
                              <linearGradient id="paint0_linear_17_195" x1="8.09987" y1="4.94" x2="40.0375" y2="43.8142" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#FFD9A0"/>
                                <stop offset="1" stop-color="#6FDDE1"/>
                              </linearGradient>
                            </defs>
                          </svg>
                    </div>
                    <div class="cmn-textslide">Packaging</div>
                    <div class="icon-mar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                            <g clip-path="url(#clip0_17_180)">
                              <mask id="mask0_17_180" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="52" height="52">
                    ...
                    <div class="cmn-textslide">Sticker Print</div>
                    <div class="icon-mar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                            <g clip-path="url(#clip0_17_180)">
                              <mask id="mask0_17_180" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="52" height="52">
                    ...
                    <div class="cmn-textslide">Custom Print</div>
                </div>
                <div class="comm">
                    <div class="icon-mar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                    ...
                    <div class="cmn-textslide">Business Card</div>
                    <div class="icon-mar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                            <g clip-path="url(#clip0_17_188)">
                              <mask id="mask0_17_188" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="52" height="52">
    ...
    <!-- Cta Section Start -->
    <section class="cta-section section-padding fix bg-cover" style="background-image: url('{{asset('front/assets/img/cta-bg.jpg')}}');">
        <div class="container">
    ...
    <section class="choose-us-section fix section-padding">
        <div class="container">
            <div class="choose-us-wrapper">
                <div class="row g-4">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="choose-us-image reveal fix">
                            <img src="{{asset('front/assets/img/choose-us.png')}}" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-6">
    ...
    <section class="testimonial-section fix bg-cover section-padding" style="background-image: url('{{asset('front/assets/img/testimonial-bg.jpg')}}');">
        <div class="container">
            <div class="section-title text-center">
                <div class="sub-title wow fadeInUp">
                ...
                <div class="row g-4">
                    <div class="col-xl-6">
                        <div class="contact-content">
                            <div class="section-title">
                                <div class="sub-title wow fadeInUp">
                                    <span>Frequently Ask Qustion</span>
                                </div>
                                <h2 class="split-text right">
                                    Produce Stuning <br>
                                    Printing & Business
                            ...
                            <div class="row mt-4 mt-md-0 g-4">
                                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="{{asset('front/assets/img/today_def.png')}}" alt="img" style="height: 70px;">
                                        </div>
                                        <h5>Magzine Printing</h5>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="{{asset('front/assets/img/contact/icon-2.png')}}" alt="img">
                                        </div>
                                        <h5>Business Card</h5>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="{{asset('front/assets/img/contact/icon-3.png')}}" alt="img">
                                        </div>
                                        <h5>Mug Printing</h5>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="{{asset('front/assets/img/contact/icon-4.png')}}" alt="img">
                                        </div>
                                        <h5>Bill Board Print</h5>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="{{asset('front/assets/img/contact/icon-5.png')}}" alt="img">
                                        </div>
                                        <h5>Dress & Bags</h5>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                                    <div class="icon-items">
                                        <div class="icon">
                                            <img src="{{asset('front/assets/img/contact/icon-6.png')}}" alt="img">
                                        </div>
                                        <h5>Banners Print</h5>
                                    </div>
                                </div>
                    ...
                    <div class="news-box-items">
                        ...
                        <div class="news-content">
                            ...
                            <div class="author-items">
                                ...
                                <a href="{{url('/blog-details/'.$blog->slug)}}" class="link-btn">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="cta-contact-section fix pt-5 pb-5 bg-cover" style="background-image: url('{{asset('front/assets/img/cta-bg.png')}}');">
        <div class="container">
