...
Route::get('/shop/{slug?}', [HomeController::class, 'shop'])->name('shop');
Route::get('/shop-details/{slug?}', [HomeController::class, 'shopDetails'])->name('shop-details');
...
Route::get('shop-by-category/{slug}', [HomeController::class, 'shopByCategory'])->name('shop-by-category');
